        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CouponParcentange = table.Column<double>(type: "float", nullable: true),
                    CouponDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CouponCodes", x => x.Coupon_Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuList", x => x.Menu_Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoupnName = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupplerName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    SupplierStoreName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Parent_Cat_Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Parent_brand_Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Product", x => x.Product_Id);
                    table.ForeignKey(
                        name: "FK_Product_Brand_Parent_brand_Id",
                        column: x => x.Parent_brand_Id,
                        principalTable: "Brand",
                        principalColumn: "Brand_Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Product_Category_Parent_Cat_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePrivileges", x => new { x.MenuId, x.RoleId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RolePrivileges_MenuList_MenuId",
                        column: x => x.MenuId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPrivileges", x => new { x.MenuId, x.UserId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserPrivileges_MenuList_MenuId",
                        column: x => x.MenuId,
                        principalTable: "MenuList",
                        principalColumn: "Menu_Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prod_Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Clib", x => x.Image_Id);
                    table.ForeignKey(
                        name: "FK_Clib_Product_Prod_Id",
                        column: x => x.Prod_Id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clib_Prod_Id",
                table: "Clib",
                column: "Prod_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Product_Parent_brand_Id",
                table: "Product",
                column: "Parent_brand_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Product_Parent_Cat_Id",
                table: "Product",
